...
pub struct RegionScoringParams {
    ...
    pub area_power: f64,
    pub region_area_weight: f64,
    pub region_subject_weight: f64,
    pub region_saliency_mean_weight: f64,
    pub region_saliency_peak_weight: f64,
    pub region_foreground_weight: f64,
    pub region_center_weight: f64,
    pub region_saturation_weight: f64,
    pub color_stability_weight: f64,
    pub bg_probability_penalty_strength: f64,
    ...
    pub subject_prominence_bonus_strength: f64,
    pub min_region_area_ratio: f64,
...
impl Default for RegionScoringParams {
    fn default() -> Self {
        Self {
            ...
            area_power: 0.55,
            region_area_weight: 0.18,
            region_subject_weight: 0.28,
            region_saliency_mean_weight: 0.18,
            region_saliency_peak_weight: 0.20,
            region_foreground_weight: 0.20,
            region_center_weight: 0.08,
            region_saturation_weight: 0.12,
            color_stability_weight: 0.30,
            bg_probability_penalty_strength: 0.45,
            bg_flat_penalty_strength: 0.55,
            bg_flat_area_min_ratio: 0.08,
            bg_flat_area_full_ratio: 0.35,
            bg_flat_sat_threshold: 0.28,
            subject_prominence_bonus_strength: 0.20,
...
pub struct ClusterScoringParams {
    ...
    /// 肤色惩罚强度 [0, 1]。0 = 禁用, 越大越压制肤色簇胜出
    pub skin_penalty_strength: f64,
}
